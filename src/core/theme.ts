...
let currentConfig: ThemeConfig = { mode: 'system' };
 ...
 */
export function setVariables(variables: Record<string, string>): void {
 ...
 */
export function setBorderRadius(scale: ThemeConfig['borderRadius']): void {
 ...
 */
export function applyConfig(config: Partial<ThemeConfig>): void {
  if (config.mode) {
 ...
 */
export function exportThemeJS(): string {
