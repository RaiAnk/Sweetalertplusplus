...
export { alert, analyticsPlugin, announce, applyConfig, applyMask, applyPreset, clearQueue, close, closeAll, configureQueue, confirm, confirmOnClosePlugin, createDebouncedValidator, createFocusTrap, createFormSchema, createIcon, createMaskedInput, createQueue, darkModePlugin, SweetAlertPlusPlus as default, deleteQueue, dismissAllToasts, dismissToast, enqueue, enqueueAll, error$1 as error, escapeHtml, exportThemeCSS, exportThemeJS, form, formPresets, getActiveModal, getActiveModals, getConfig, getGlobalConfig, getInstalledPlugins, getQueueStatus, getResolvedTheme, getTheme, getToastDefaults, getVariable, image, info$1 as info, initDeclarativeModals, initTheme, isAnyOpen, isOpen, isPluginInstalled, keyboardPlugin, loading$1 as loading, modal, pauseQueue, plugins, prefersReducedMotion, presets, prompt, queue, registerFieldRenderer, registerIcon, registerValidator, renderForm, resetVariables, resumeQueue, sanitize, setAnimationSpeed, setAnimations, setBorderRadius, setGlobalConfig, setPrimaryColor, setTheme, setToastDefaults, setVariable, setVariables, show, skipCurrent, soundPlugin, stripTags, success$1 as success, themePresets, toast, error as toastError, info as toastInfo, loading as toastLoading, promise as toastPromise, success as toastSuccess, warning as toastWarning, toggleTheme, unmask, unregisterIcon, unregisterValidator, unuse as unusePlugin, update, use as usePlugin, validateField, validateForm, warning$1 as warning, wizard };
//# sourceMappingURL=sweetalert-plus-plus.esm.js.map
