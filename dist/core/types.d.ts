...
export type FieldType = 'text' | 'email' | 'password' | 'url' | 'tel' | 'search' | 'number' | 'currency' | 'percentage' | 'range' | 'rating' | 'date' | 'time' | 'datetime' | 'daterange' | 'month' | 'week' | 'select' | 'multiselect' | 'radio' | 'checkbox' | 'switch' | 'toggle' | 'textarea' | 'richtext' | 'code' | 'markdown' | 'file' | 'image' | 'avatar' | 'color' | 'tags' | 'autocomplete' | 'otp' | 'pin' | 'signature' | 'slider' | 'divider' | 'heading' | 'paragraph' | 'hidden';
export interface ValidationRule {
    /** Rule type */
    type: 'required' | 'email' | 'url' | 'min' | 'max' | 'minLength' | 'maxLength' | 'pattern' | 'custom' | 'match' | 'unique' | 'phone' | 'creditCard' | 'date' | 'dateRange' | 'fileSize' | 'fileType' | 'dimensions';
    /** Error message */
    message?: string;
...
export type FormField = TextFieldConfig | NumberFieldConfig | RangeFieldConfig | RatingFieldConfig | DateFieldConfig | DateRangeFieldConfig | SelectFieldConfig | SwitchFieldConfig | TextareaFieldConfig | FileFieldConfig | ColorFieldConfig | TagsFieldConfig | AutocompleteFieldConfig | OTPFieldConfig | SignatureFieldConfig | DividerConfig | HeadingConfig | ParagraphConfig | HiddenFieldConfig;
...
export type DismissReason = 'backdrop' | 'escape' | 'close' | 'timer' | 'cancel' | 'programmatic';
